"""Number platform: bed head/foot position (0-100)."""
...
class DeskBedNumber(CoordinatorEntity, NumberEntity):
    """Represent a bed head/foot position as a number."""
